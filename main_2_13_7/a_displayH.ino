...
uint16_t diagnosticBox = 0x249A;
uint16_t testRotate = 0x259A;
uint16_t testWhite = 0x25A4;
uint16_t testBlue = 0x25AE;
uint16_t testSource = 0x25B8;
uint16_t testTime = 0x25C2;
